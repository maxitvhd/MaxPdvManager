      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            ...
            <p class="text-lead text-white">Use estes formulários incríveis para entrar ou criar uma nova conta no seu
              projeto gratuitamente.</p>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="card z-index-0">
            ...
            <div class="card-body">
              <form role="form text-left" method="POST" action="/register">
                @csrf
                <div class="mb-3">
                  <input type="text" class="form-control" placeholder="Nome" name="name" id="name" aria-label="Name"
                ...
                <div class="mb-3">
                  <input type="email" class="form-control" placeholder="E-mail" name="email" id="email" aria-label="Email"
                ...
                <div class="mb-3">
                  ...
                  <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="roles[]" value="dono" id="dono">
                    <label class="form-check-label" for="dono">Dono</label>
                  </div>
                  <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="roles[]" value="usuario" id="usuario">
                    <label class="form-check-label" for="usuario">Usuário</label>
                  </div>
                  <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="roles[]" value="funcionario" id="funcionario">
                    <label class="form-check-label" for="funcionario">Funcionário</label>
                  </div>
                  <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="roles[]" value="contador" id="contador">
                    <label class="form-check-label" for="contador">Contador</label>
                  </div>
                  <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="roles[]" value="fornecedor" id="fornecedor">
                    <label class="form-check-label" for="fornecedor">Fornecedor</label>
                  </div>
                  <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="roles[]" value="prestador" id="prestador">
                ...
                <div class="form-check form-check-info text-left">
                  ...
                  @error('agreement')
                    <p class="text-danger text-xs mt-2">Primeiro, concorde com os Termos e Condições e tente registrar
                      novamente.</p>
                  @enderror
                </div>
                ...
                <p class="text-sm mt-3 mb-0">Já tem uma conta? <a href="login"
