            ...
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Loja / Responsável</th>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div>
                            <div class="avatar avatar-sm me-3 bg-gradient-dark d-flex align-items-center justify-content-center rounded-circle">
                      ...
                      <td class="align-middle">
                        ...
                        <a href="{{ route('lojas.edit', $loja->codigo) }}" class="text-secondary font-weight-bold text-xs me-3" 
                           data-bs-toggle="tooltip" data-bs-title="Editar Loja">
                          <i class="fas fa-pencil-alt text-lg"></i>
                        </a>

                        <a href="{{ route('funcionarios.index', ['loja' => $loja->codigo]) }}" 
                        class="text-info font-weight-bold text-xs me-3" 
                        data-bs-toggle="tooltip" data-bs-title="Gerenciar Equipe">
                        <i class="fas fa-users-cog text-lg"></i>
                        </a>

                        <form action="{{ route('lojas.destroy', $loja->codigo) }}" method="POST" class="d-inline delete-form">
                            @csrf
                            @method('DELETE')
