        ...
        <div class="col-12 col-lg-8 mx-auto">
            <div class="card mb-4">
                ...
                <div class="card-header pb-0 border-bottom">
                    <h6 class="mb-0">Criar Novo Plano</h6>
                </div>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('planos.store') }}" method="POST">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="number" min="1" name="meses_validade"
                                        value="{{ old('meses_validade') }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="number" min="1" name="limite_dispositivos"
                                        value="{{ old('limite_dispositivos') }}" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="d-flex justify-content-end mt-4">
                            ...
                            <button type="submit" class="btn bg-gradient-primary btn-md mb-0">Salvar Plano</button>
                        </div>
                    </form>
                </div>
