...
<div class="d-flex flex-column" style="height:calc(100vh - 60px); padding:0;">
    ...
    {{-- Top Bar --}}
    <div class="d-flex align-items-center justify-content-between px-3 py-2 bg-dark flex-shrink-0 border-bottom border-secondary">
...
<style>
    ...
    .main-content .row { padding: 0 !important; margin: 0 !important; max-width: 100% !important; }
    #gjs { width: 100%; }
    .gjs-logo { display: none; }
    .gjs-block-category .gjs-title { background: #374151; color: #f9fafb; font-size: 11px; }
    .gjs-block { border: 1px solid #374151 !important; color: #d1d5db; background: #1f2937; }
    .gjs-block:hover { background: #374151 !important; border-color: #6d28d9 !important; }
    .gjs-one-bg { background: #111827; }
    .gjs-two-bg { background: #1f2937; }
    [data-type="ai-area"] {
        border: 2px dashed #7c3aed !important; min-height: 50px;
        background: rgba(124,58,237,.06) !important;
        display: flex; align-items: center; justify-content: center;
        color: #7c3aed; font-weight: bold; font-size: 12px; font-family: sans-serif;
    }
</style>
@endpush
...
// ════════════════════════════════════════════════════════
//  Placeholders usam [[ ]] para não conflitar com Blade {{ }}
// ════════════════════════════════════════════════════════
